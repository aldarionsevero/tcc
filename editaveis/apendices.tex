...
\chapter{Manipulação de arquivos de configuração em Ruby}
\label{apc:conf-file}
...
\noindent\begin{minipage}{\textwidth}
  \lstset{style=shell}
  \lstinputlisting[language=Ruby, frame=single, label=code:config, caption="Módulo que carrega as configurações"]{conteudo/code/config.rb}
\end{minipage}\hfill

\noindent\begin{minipage}{\textwidth}
  \lstset{style=shell}
  \lstinputlisting[language=Ruby, frame=single, label=code:cuperfile, caption="Exemplo de Cupperfile"]{conteudo/code/cupperfile.rb}
\end{minipage}\hfill
...
\noindent\begin{minipage}{\textwidth}
  \lstset{style=shell}
  \lstinputlisting[language=Ruby, frame=single, label=code:cupsconfig, caption="Arquivo de configuração para o CUPS"]{conteudo/code/cupsconfig}
\end{minipage}\hfill

\noindent\begin{minipage}{\textwidth}
  \lstset{style=shell}
  \lstinputlisting[language=Ruby, frame=single, label=code:nginxconfig, caption="Arquivo de configuração para o \textit{nginx}"]{conteudo/code/nginxconfig}
\end{minipage}\hfill
