...
%\input{conteudo/levantamento_escopo/attributes}
\input{conteudo/levantamento_escopo/recipes}
%\input{conteudo/levantamento_escopo/definitions}
\input{conteudo/levantamento_escopo/files}
%\input{conteudo/levantamento_escopo/libraries}
%\input{conteudo/levantamento_escopo/custom}
%\input{conteudo/levantamento_escopo/metadata}
\input{conteudo/levantamento_escopo/resources}
%\input{conteudo/levantamento_escopo/templates}
