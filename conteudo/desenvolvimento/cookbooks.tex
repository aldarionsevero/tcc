...
\textbf{Cupper}: será incluso no escopo de implementação.
...
feito. Por exemplo, o \textit{resource} diz "instale o pacote A" e o \textit{provider} decide
ser deve utilizar pacotes deb ou rpm.
