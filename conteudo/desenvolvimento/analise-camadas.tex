...
\begin{tabular}[c]{@{}c@{}}Modelo \\ Motherboard\end{tabular}   & dmidecode & não        & não     &      & não          \\ \hline
Versão BIOS                                                     & dmidecode & não        & não     &      & não          \\ \hline
Flags BIOS                                                      & dmidecode & não        & não     &      & não          \\ \hline
Slots Memória                                                   &          & não        & sim     &      & não          \\ \hline
Marca Memória                                                   & dmidecode & não        & sim     &      & não          \\ \hline
...
\begin{tabular}[c]{@{}c@{}}Dispositivos \\ de Rede\end{tabular}          & \begin{tabular}[c]{@{}c@{}}lspci/\\ ifconfig/\\ dmidecode\end{tabular} &            &         &      &              \\ \hline
\end{tabular}
\end{table}
