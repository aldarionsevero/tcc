...
arquivos de configuração podem ser instalados em diretórios fora  do padrão HFS.
Dessa maneira, além de \textit{plugins} para o \textit{Ohai}, \textit{plugins}
para o \textit{Cupper} também devem ser feitos para tratar esses casos especiais.
