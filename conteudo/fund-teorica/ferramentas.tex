...
\cite{sharma:2015} lista as ferramentas de automação que são alternativas ao
...
\begin{table}[h]
  ...
  \end{tabular}
  \caption{Comparativo das ferramentas de automação (Adaptado)}
\end{table}

Outras vantagens e pontos chaves que o Chef tem em relação ao seus
