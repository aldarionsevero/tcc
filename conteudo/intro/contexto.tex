...
a buscarem por modelos dos quais ofereçam uma constante entrega de produto com
...
A adoção de \textit{DevOps} \textit{(Development and Operation)} vem sendo feita
...
a fim de facilitar na replicação, documentação e migração da infraestrutura. % TODO: infraestrutura é muito amplo?
