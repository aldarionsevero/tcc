...
% TODO: a árvore de subseções está um pouco grande, talvez devesse diminuir
...
Apesar de não ter sido identificado outra ferramenta similar, com exceção ao Blueprint,
para as outras ferramentas de automação de infraestrutura, como o Puppet e Ansible,
