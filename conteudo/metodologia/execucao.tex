...
Diversos dos conceitos e práticas abordados nessa seção também são abordados na
seção~\ref{sec:devops}, mas aqui são redefinidas e adaptadas para o escopo do
trabalho.
